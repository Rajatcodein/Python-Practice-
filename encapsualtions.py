    ...
    def withdraw(self):
        ...
        if user_pin == self.pin:
            ...
            if amount < self.__balance :
                ...
                print('withdraw sucessfully. balance is ',self.__balance)
            else:
                print('insuficient balance ',self.__balance)
        else:
            print('please dekh le bhai tera hi account hai .....')
                 
obj = Oops()
#obj._Oops__balance = 'hi paise chaiye'
obj.get_balance()
print(obj.get_balance())
obj.set_balance(10000)
print(obj.set_balance(10000))
obj.withdraw()
